...
<body>
	<form class="layui-form" action="NewFile.jsp" id="loginForm">
		<div class="layui-form-item">
			<h1>学生成绩管理系统</h1>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
				<span class="decrib">账号：</span> <input type="text" name="usercode"
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<span class="decrib">类型：</span> <input type="text" name="type"
		...
		<a  href="Zhuche.jsp" class="layui-btn layui-btn-warm " id="zhuce">注册</a>
		<br> <br>
	</form>
</body>
